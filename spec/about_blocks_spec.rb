...
describe "Blocks" do
  ...
  it "should demonstrate methods_can_call_yield_many_times" do
    ...
    result.should eql [:peanut, :butter, :and, :jelly]
  end
  ...
  it "should demonstrate methods_can_see_if_they_have_been_called_with_a_block" do
    yield_tester { :with_block }.should eql :with_block
    yield_tester.should eql :no_block
  end
  ...
  it "should demonstrate methods_can_take_an_explicit_block_argument" do
    method_with_explicit_block { |n| n * 2 }.should eql 20

    add_one = lambda { |n| n + 1 }
    method_with_explicit_block(&add_one).should eql 11
  end
end