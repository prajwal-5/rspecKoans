...
describe "Sandwich Code" do
  ...
  it "should demonstrate counting_lines" do
    count_lines("example_file.txt").should eql 5
  end
  ...
  it "should demonstrate finding_lines" do
    find_line("example_file.txt").should eql "The Ruby Koans walk you along the path to enlightenment in order to learn Ruby.\n"
  end
  ...
  it "should demonstrate counting_lines2" do
    count_lines2("example_file.txt").should eql 5
  end
  ...
  def find_line2(file_name)
    ...
    file_sandwich("example_file.txt") {|file| count = 0
    while line = file.gets
      count += 1
    end
    count}
  ...
  it "should demonstrate finding_lines2" do
    find_line2("example_file.txt").should eql 5
  end
  ...
  it "should demonstrate open_handles_the_file_sandwich_when_given_a_block" do
    count_lines3("example_file.txt").should eql 5
  end
end